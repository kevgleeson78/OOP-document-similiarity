...
public class Launcher {
	...
	public void launch(String f1, String f2) throws Exception {
		...
		Thread t1 = new Thread(new DocumentParser(f1, q, 6, 20, 1), "T1");

		Thread t2 = new Thread(new DocumentParser(f2, q, 6, 20, 2), "T2");

		Thread t3 = new Thread(new Consumer(q, 20, 10), "T3");
